...
#10
#a.
vegetables <- c("Squash", "Okra", "Eggplant ", "Tomato", "Cucumber", "Bitter Melon", "String Beans ", "Water Spinach", "Winged Bean", "Cabbage")
vegetables

#b.
vegetables <- c(vegetables, "Radish ", "Moringga")
vegetables

#c.
vegetables <- append(vegetables, c("Sponge Gourd", "Chayote", "Celery", "Artichoke"), after = 5)
